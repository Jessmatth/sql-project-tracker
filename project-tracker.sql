...
COPY public.projects (id, title, description, max_greed) FROM stdin;
1	Markov	Tweets generated from Markov chains	50
2	Blockly	Our first lab	50
3	SQLZOO	Write a lot of queries	20
4	BASH SCROLL	Practice bash	20
\.
